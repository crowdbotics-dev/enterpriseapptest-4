"""
Django settings for enterpriseapptest_4 project.
...
ROOT_URLCONF = 'enterpriseapptest_4.urls'
...
WSGI_APPLICATION = 'enterpriseapptest_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "enterpriseapptest_4 API",
    "DESCRIPTION": "API documentation for enterpriseapptest_4 App",
    "VERSION": "v1",
}
